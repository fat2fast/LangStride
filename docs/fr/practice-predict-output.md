...
### FR-OUTPUT-002 — Expected behaviour submission
A learner shall be able to submit expected output or behaviour. Done when the challenge accepts the supported prediction format.

### FR-OUTPUT-003 — Deterministic validation
Validation shall be deterministic. Done when normalization rules and expected output produce the same result for the same submission.
