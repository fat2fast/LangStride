...
### FR-MCQ-002 — Exact validation
Multiple-choice validation shall support a precisely defined correct answer or answer set. Done when the same submitted selection always produces the same result.
